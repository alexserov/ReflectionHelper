...
namespace DevExpress.Xpf.Core.ReflectionExtensions {
    ...
    public static class ReflectionHelperExtensions {
        ...
        static ReflectionHelperExtensions() {
            ...
            moduleBuilder = assemblyBuilder.DefineDynamicModule(typesModuleName, typesModuleName + ".dll", true);
#else
...
#if DEBUGTEST
        public static void Save() { assemblyBuilder.Save("ReflectionHelperTypes.dll"); }
#endif
    }
}